...
<t:mainlayout>
    ...
    <form action="./pacientes/novo" method="post" enctype="application/x-www-form-urlencoded">
        <div class="form">
            <div class="input">
                <input type="text" id="y1" name="nome_completo" required>
                <label for="y1">Nome do Paciente</label>
            </div>

            <div class="input">
                <input type="text" id="y2" name="data_nascimento"
                       pattern="^(?:0[1-9]|[12][0-9]|3[01])(.)(?:0[1-9]|1[0-2])\1(?:19|20)[0-9]{2}$" required>
            ...
            <div class="input">
                <input type="email" id="y3" name="email" required>
                <label for="y3">E-mail</label>
            </div>

            <div class="input">
                <input type="text" id="y4" name="cpf"
                       pattern="^(?:[0-9]{3}\.){2}[0-9]{3}\-[0-9]{2}$" required>
                <label for="y4">CPF</label>
            </div>

            <div class="input">
                <input type="text" id="y5" name="rg" pattern="^\d{1,3}(?:\.\d{3})*$">
