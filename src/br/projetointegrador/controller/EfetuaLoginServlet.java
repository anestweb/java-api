...
public class EfetuaLoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			aut = daoUsuario.autenticaUsuario(email, senha);
			
			if(aut){
				response.sendRedirect("HomeSistema.jsp");
			}else{
